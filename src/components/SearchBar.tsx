  ...
  return (
    <div className="relative mr-2 flex max-w-[250px] items-center sm:mr-0">
      <input
        ...
        autoComplete="off"
        className="w-full appearance-none rounded-md bg-gray-900/75 py-2 pr-7 pl-9 text-xs text-paragraph placeholder-gray-400 caret-gray-200 outline-none transition duration-200 focus:bg-gray-900/90 focus:ring-2 focus:ring-gray-200 sm:text-sm"
      ...
      >
        <RiCloseFill
          className="h-5 w-5 text-gray-500 transition duration-200 hover:text-gray-300 xs:h-6 xs:w-6"
          aria-hidden
        />
      </button>
      <label htmlFor="search" className="absolute left-2 cursor-pointer">
        ...
        >
          <FiSearch
            className="h-5 w-5 text-gray-300 transition duration-200 hover:text-gray-50"
            aria-hidden
          />
        </button>
      </label>
